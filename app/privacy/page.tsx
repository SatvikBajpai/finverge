      ...
      <main className="flex-1">
        <section className="w-full py-12 md:py-24 bg-background">
          <div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-3xl">
            <h1 className="text-3xl font-bold tracking-tighter sm:text-4xl md:text-5xl text-foreground mb-8 text-center">Privacy Policy</h1>
            <p className="text-muted-foreground mb-4 text-sm text-center">Effective Date: 21st March, 2025</p>
            <div className="prose dark:prose-invert max-w-none text-foreground">
              <p className="text-muted-foreground">Finverge Advisors ("we," "us," or "our") is committed to protecting your privacy. This Privacy Policy explains how we collect, use, and safeguard your information when you visit our website <span className='break-all'>www.finvergeadvisors.com</span>.</p>
              <ol className="list-decimal pl-6 space-y-4 text-muted-foreground">
                ...
                <li>
                  <strong className="text-foreground">How We Use Your Information:</strong>
                  <ul className="list-disc pl-6 mt-2">
                ...
                <li>
                  <strong className="text-foreground">Information Sharing:</strong>
                  <ul className="list-disc pl-6 mt-2">
                ...
                <li>
                  <strong className="text-foreground">Cookies and Data Retention:</strong>
                  <ul className="list-disc pl-6 mt-2">
                ...
                <li>
                  ...
                  <ul className="list-disc pl-6 mt-2">
                    <li>You may access, update, or delete your personal information by contacting us at <a href="mailto:contact@finvergeadvisors.com" className="text-amber-500 hover:text-amber-400">contact@finvergeadvisors.com</a>.</li>
                  </ul>
                </li>
                <li>
                  <strong className="text-foreground">Changes to This Privacy Policy:</strong>
                  <ul className="list-disc pl-6 mt-2">
                ...
                <li>
                  ...
                  <ul className="list-disc pl-6 mt-2">
                    <li>If you have any questions, contact us at: <a href="mailto:vishal@finvergeadvisors.com" className="text-amber-500 hover:text-amber-400">vishal@finvergeadvisors.com</a>.</li>
                  </ul>
                </li>
              </ol>
            </div>
